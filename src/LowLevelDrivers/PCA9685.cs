	...
	public class PCA9685 {
		...
		public PCA9685(I2cDevice device, GpioPin outputEnable) {
			...
			if (this.outputEnable != null) {
				this.outputEnable.SetPinMode(PinMode.Output);
				// = Unosquare.RaspberryIO.Gpio.GpioPinDriveMode.Output;
                
				this.outputEnable.Write(PinValue.Low);
			}
		...
		public bool OutputEnabled {
			...
			set {
				...
				this.outputEnable.Write(value ? PinValue.Low : PinValue.High);
			}
		}
